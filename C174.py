...
root.config(bg='#0054f6')
logo = ImageTk.PhotoImage(Image.open("logo.png"))
place_image=Label(root,image=logo,borderwidth=0)
place_image.place(relx=0.7, rely=0.5,anchor=CENTER)
label = Label(root, text="Assigning Jobs",font=("French Script MT",20,"bold"),bg='#0054f6',fg="white")
label.place(relx=0.1, rely=0.06,anchor=CENTER)

#------------------Label for string Docter-------------
label_doctor=Label(root,text="Doctor : ",bg='#0054f6')
label_doctor.place(relx=0.04,rely=0.15,anchor=CENTER)

#------------------Label for string IT professional-------------
label_IT=Label(root,text="IT professional : ",bg='#0054f6')
label_IT.place(relx=0.06,rely=0.45,anchor=CENTER)

#------------------Label for string "Chemical Engineer ------------
label_chemical=Label(root,text="Chemical Engineer : ",bg='#0054f6')
...
#------------------------Labels selected--------------------------
label_selected_doctor=Label(root, font=("times",12,"bold"),fg="dark olive green",bg='#0054f6')
label_selected_doctor.place(relx=0.01, rely=0.3,anchor=W)

label_selected_IT=Label(root,font=("times",12,"bold"),fg="dark olive green",bg='#0054f6')
label_selected_IT.place(relx=0.01, rely=0.6,anchor=W)

label_selected_chemical=Label(root, font=("times",12,"bold"),fg="dark olive green",bg='#0054f6')
